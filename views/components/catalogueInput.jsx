...
class CatalogueItemInput extends React.Component {
    render() {
        return (
            ...
            <div className="field">
              <label>Price</label> <input type="text" name="price1" autoComplete="off" required/>
              </div>
            <div className="field">
              <label>Description</label> <input type="text" name="product_desc1" autoComplete="off" required/>
              </div>
            <div className="field">
